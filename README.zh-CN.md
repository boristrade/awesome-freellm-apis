<p align="center">
  ...
  <!-- AUTO_STATS -->
  <p align="center"><strong>167+ 免费大模型 API，来自 25 个提供商</strong> — 一站式发现、对比、配置免费模型。</p>
<!-- END_AUTO_STATS -->
</p>
...
<p align="center">
  ...
  <!-- AUTO_UPDATE_BADGE -->
  <p align="center"><strong>🔄 数据每日从 <a href="https://freellm.net" target="_blank" rel="noopener">freellm.net</a> 自动更新</strong> — 最后更新: 2026-06-17</p>
